...
static SECP256K1_INLINE void secp256k1_callback_call(secp256k1_callback *cb,
...
static SECP256K1_INLINE void *checked_malloc(secp256k1_callback *cb,
                                             size_t size)
{
...
static SECP256K1_INLINE void *checked_realloc(secp256k1_callback *cb, void *ptr,
                                              size_t size)
{
