...
#include "../components/cy_memory_unit.h"
#include "cy_errors.h"
...
extern cy_error_t cy_fp_sub(fp_ctx_t *ctx,  cy_fp_t *a, cy_fp_t *b, cy_fp_t *r);

extern cy_error_t cy_fp_mul(fp_ctx_t *ctx,  cy_fp_t *a, cy_fp_t *b, cy_fp_t *r);

extern cy_error_t cy_fp_to_mont(fp_ctx_t *ctx,  cy_fp_t *in, cy_fp_t *out);


extern cy_error_t cy_fp_mult_mont(fp_ctx_t *ctx,  cy_fp_t *a, cy_fp_t *b, cy_fp_t *r);
