...
#ifndef SRC_OBJECTC_CY_GDA_COMPONENT_H_
#define SRC_OBJECTC_CY_GDA_COMPONENT_H_


typedef cy_error_t (*Fct_Gda_Init_t) (void *io_ps_ctx, uint8_t *initializer, size_t initializer_t8);
typedef cy_error_t (*Fct_Gda_Run_t) (void *io_ps_ctx,  uint8_t *out, size_t out_t8);
...
typedef struct gda_ctx_s gda_ctx_t;
